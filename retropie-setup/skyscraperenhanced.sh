...
function _cache_folder_skyscraper-enhanced() {
...
function _purge_skyscraper-enhanced() {
    local platform
    local cache_folder=$(_cache_folder_skyscraper-enhanced)
...
function _purge_platform_skyscraper-enhanced() {
    local options=()
    local cache_folder=$(_cache_folder_skyscraper-enhanced)
    local system
...
function _scrape_skyscraper-enhanced() {
    local system="$1"
...
function _open_editor_skyscraper-enhanced() {
    local editor
...
function _gui_advanced_skyscraper-enhanced() {
...
function gui_skyscraper-enhanced() {
...
function _gui_cache_skyscraper-enhanced() {
    local db_size
    local cache_folder=$(_cache_folder_skyscraper-enhanced)
...
function _gui_generate_skyscraper-enhanced() {
